import svgPaths from "./svg-qvbqextc3x";
...
function Container() {
  return (
    <div className="bg-[#eee] content-stretch flex items-center justify-center p-[8px] relative rounded-[48px] shrink-0" data-name="Container">
      <Icon />
    </div>
  );
}
