import svgPaths from "./svg-03o48o6cme";
...
function Typography1() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Typography">
      <p className="font-['Open_Sans:Regular',sans-serif] leading-[20px] not-italic relative shrink-0 text-[14px] text-[rgba(0,0,0,0.8)] tracking-[0.028px] w-full whitespace-pre-wrap">O destinatário receberá sua mensagem em breve.</p>
    </div>
  );
}
...
export default function Modal() {
  return (
    <div className="content-stretch flex flex-col items-start p-[24px] relative size-full" data-name="Modal">
      <Body />
