import svgPaths from "./svg-2thddbw509";
...
function Batidas() {
  return (
    <div className="content-stretch flex gap-[12px] items-start relative shrink-0" data-name="batidas">
      <div className="flex flex-col font-['Open_Sans:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#58586b] text-[14px] tracking-[0.035px] w-[361px]">
        <p className="leading-[20px] whitespace-pre-wrap">Não há batidas</p>
      </div>
    </div>
  );
}
        ...
        <div className="content-stretch flex gap-[8px] items-center px-[16px] py-[10px] relative size-full">
          <div className="content-stretch flex flex-[1_0_0] items-center min-h-px min-w-px relative" data-name="Typography">
            <div className="flex flex-[1_0_0] flex-col font-['Open_Sans:Regular',sans-serif] justify-center leading-[0] min-h-px min-w-px not-italic relative text-[#58586b] text-[14px] tracking-[0.1246px]">
              <p className="leading-[18px] whitespace-pre-wrap">Selecione o motivo</p>
            </div>
          </div>
...
export default function CancelarBatidaSemRegistros() {
  return (
    <div className="bg-white relative size-full" data-name="Cancelar batida – Sem registros">
      <Header />
      <Body />
    </div>
  );
