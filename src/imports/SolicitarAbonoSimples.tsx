import svgPaths from "./svg-lbe3h0908";
...
function Body() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col h-[888px] items-start justify-between p-[24px] right-0 top-[118px] w-[393px]" data-name="Body">
      <Frame4 />
      <Frame3 />
    </div>
  );
...
export default function SolicitarAbonoSimples() {
  return (
    <div className="bg-white relative size-full" data-name="Solicitar Abono - Simples">
      <Header />
      <Body />
    </div>
  );
