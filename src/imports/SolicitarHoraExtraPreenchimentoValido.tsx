import svgPaths from "./svg-3vslweu1ai";
    ...
    <div className="bg-white flex-[1_0_0] h-full min-h-px min-w-px relative rounded-[4px]" data-name="Box">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[8px] items-center px-[16px] py-[10px] relative size-full">
          ...
          <div className="content-stretch flex flex-[1_0_0] items-center min-h-px min-w-px relative" data-name="Typography">
            <div className="flex flex-col font-['Open_Sans:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#3a3a45] text-[14px] tracking-[0.1246px] whitespace-nowrap">
        ...
        <div className="content-stretch flex items-center px-[16px] py-[10px] relative size-full">
          <div className="content-stretch flex flex-[1_0_0] items-center min-h-px min-w-px relative" data-name="Typography">
            <div className="flex flex-[1_0_0] flex-col font-['Open_Sans:Regular',sans-serif] justify-center leading-[18px] min-h-px min-w-px not-italic relative text-[#3a3a45] text-[14px] tracking-[0.1246px] whitespace-pre-wrap">
              <p className="mb-0">Permaneci após o expediente para finalizar relatório.</p>
              <p className="mb-0">&nbsp;</p>
              <p className="mb-0">&nbsp;</p>
              <p className="mb-0">&nbsp;</p>
              <p className="mb-0">&nbsp;</p>
...
export default function SolicitarHoraExtraPreenchimentoValido() {
  return (
    <div className="bg-white relative size-full" data-name="Solicitar hora extra – Preenchimento válido">
      <Header />
      <Body />
    </div>
  );
