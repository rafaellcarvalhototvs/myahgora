import svgPaths from "./svg-kwlzanvkwb";
...
export default function SolicitarHoraExtraFormularioInicial() {
  return (
    <div className="bg-white relative size-full" data-name="Solicitar hora extra – Formulário inicial">
      <Header />
      <Body />
    </div>
  );
