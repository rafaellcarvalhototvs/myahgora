import svgPaths from "./svg-o25zlfoige";
...
function Preview() {
  return (
    <div className="content-stretch cursor-pointer flex items-start pr-px relative shrink-0 w-full" data-name="Preview">
      ...
      <button className="bg-[#0c6d9e] flex-[1_0_0] min-h-px min-w-px mr-[-1px] relative" data-name="Button group">
        <div className="flex flex-row items-center justify-center size-full">
          <div className="content-stretch flex items-center justify-center px-[8px] py-[8.5px] relative w-full">
            <div className="flex flex-col font-['Open_Sans:SemiBold',sans-serif] font-semibold justify-center leading-[0] relative shrink-0 text-[#f9f9f9] text-[14px] text-left whitespace-nowrap" style={{ fontVariationSettings: "\'wdth\' 100" }}>
  ...
  return (
    <div className="content-stretch flex gap-[16px] items-end justify-end relative shrink-0 w-full" data-name="button-group">
      <div className="bg-[#0c6d9e] flex-[1_0_0] min-h-px min-w-px relative rounded-[4px]" data-name="BTN">
        <div className="flex flex-row items-center justify-center size-full">
          <div className="content-stretch flex items-center justify-center pb-[14px] pt-[15px] px-[24px] relative w-full">
...
export default function MyAhgoraConfigLembrete() {
  return (
    <div className="bg-white relative size-full" data-name="My-Ahgora-config-lembrete03">
