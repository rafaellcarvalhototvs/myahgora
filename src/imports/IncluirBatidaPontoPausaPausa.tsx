import svgPaths from "./svg-brjkp690dq";
...
export default function IncluirBatidaPontoPausaPausa() {
  return (
    <div className="bg-white relative size-full" data-name="Incluir Batida - Ponto/Pausa - Pausa">
      <Header />
      <MainContainer />
    </div>
  );
