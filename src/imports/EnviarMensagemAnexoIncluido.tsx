import svgPaths from "./svg-q5jyb94q4p";
          ...
          <div className="overflow-clip relative shrink-0 size-[24px]" data-name="event-note">
            <div className="absolute inset-[4.17%_12.5%_12.5%_12.5%]" data-name="Vector">
              <svg className="absolute block inset-0" fill="none" preserveAspectRatio="none" viewBox="0 0 18 20">
                <path d={svgPaths.p34058100} fill="var(--fill-0, #3A3A45)" id="Vector" />
              </svg>
            </div>
          </div>
          <div className="content-stretch flex flex-[1_0_0] items-center min-h-px min-w-px relative" data-name="Typography">
  ...
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start justify-center relative shrink-0 w-[148.5px]" data-name="Text">
      <div className="content-stretch flex items-center justify-center relative shrink-0" data-name="Typography">
        <div className="flex flex-col font-['Open_Sans:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#2a2a33] text-[14px] tracking-[0.028px] whitespace-nowrap">
          <p className="leading-[20px]">atestado_medico.pdf (1.2MB)</p>
        </div>
      </div>
    </div>
  );
...
function Content3() {
  return (
    <div className="relative rounded-[4px] shrink-0 w-full" data-name="Content">
      <div aria-hidden="true" className="absolute border-[#e7e7eb] border-b border-solid inset-0 pointer-events-none rounded-[4px]" />
      <div className="flex flex-row items-center size-full">
          ...
          <div className="overflow-clip relative shrink-0 size-[24px]" data-name="close">
            <div className="absolute inset-[22.53%]" data-name="Vector">
              <svg className="absolute block inset-0" fill="none" preserveAspectRatio="none" viewBox="0 0 13.185 13.185">
                <path d={svgPaths.p33b4ff00} fill="var(--fill-0, #58586B)" id="Vector" />
              </svg>
            </div>
          </div>
        </div>
...
function Frame9() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-start py-[4px] relative shrink-0 w-full">
      ...
      <div className="content-stretch flex flex-col items-start justify-center relative shrink-0 w-full" data-name="Lista de motivos">
        <Content3 />
      </div>
...
export default function EnviarMensagemAnexoIncluido() {
  return (
    <div className="bg-white relative size-full" data-name="Enviar mensagem – Anexo incluído">
      <Header />
      <Body />
    </div>
  );
