import svgPaths from "./svg-htb90yexzm";
...
function Container() {
  return (
    <div className="bg-[#ddd] content-stretch flex items-center justify-center p-[8px] relative rounded-[48px] shrink-0" data-name="Container">
      <Icon />
    </div>
  );
}
