import svgPaths from "./svg-rvhvkhguip";
...
function Typography1() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Typography">
      <p className="font-['Open_Sans:Regular',sans-serif] leading-[20px] not-italic relative shrink-0 text-[14px] text-[rgba(0,0,0,0.8)] tracking-[0.028px] w-full whitespace-pre-wrap">As informações foram atualizadas no espelho.</p>
    </div>
  );
}
