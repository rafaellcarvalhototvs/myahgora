import svgPaths from "./svg-xbxzpzmj1k";
    ...
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0 w-full">
      ...
      <div className="content-stretch flex flex-[1_0_0] items-center min-h-px min-w-px relative" data-name="Typography">
        <div className="flex flex-col font-['Open_Sans:SemiBold',sans-serif] font-semibold justify-center leading-[0] relative shrink-0 text-[18px] text-white tracking-[0.027px] whitespace-nowrap" style={{ fontVariationSettings: "\'wdth\' 100" }}>
          <p className="leading-[28px]">Cancelar batida</p>
        </div>
      </div>
    </div>
  );
    ...
    <div className="content-stretch flex items-center justify-between relative shrink-0 w-full" data-name="Point Info">
      <div className="content-stretch flex items-center justify-center relative shrink-0" data-name="Typography">
        <div className="flex flex-col font-['Open_Sans:SemiBold',sans-serif] font-semibold justify-center leading-[0] relative shrink-0 text-[#2a2a33] text-[16px] tracking-[0.024px] whitespace-nowrap" style={{ fontVariationSettings: "\'wdth\' 100" }}>
          <p className="leading-[24px]">Selecione a batida</p>
        </div>
      </div>
      <div className="content-stretch flex items-center justify-center relative shrink-0" data-name="Typography">
...
function Batida() {
  return (
    <div className="content-stretch flex items-center justify-center px-[10px] py-[19px] relative rounded-[168px] shrink-0 size-[48px]" data-name="batida">
      ...
      <p className="font-['Open_Sans:Regular',sans-serif] leading-[20px] not-italic relative shrink-0 text-[#2a2a33] text-[14px] tracking-[0.035px]">12:00</p>
    </div>
  );
}
...
function Batida1() {
  return (
    <div className="content-stretch flex gap-[10px] items-center justify-center px-[10px] py-[19px] relative rounded-[168px] shrink-0 size-[48px]" data-name="batida">
      <div aria-hidden="true" className="absolute border border-[#c2c2cd] border-solid inset-0 pointer-events-none rounded-[168px]" />
      <p className="font-['Open_Sans:Regular',sans-serif] leading-[20px] not-italic relative shrink-0 text-[#2a2a33] text-[14px] tracking-[0.035px]">13:00</p>
    </div>
  );
}
...
function Check() {
  return (
    <div className="absolute bg-white left-[30px] overflow-clip rounded-[10px] size-[16px] top-0" data-name="Check">
      <div className="-translate-x-1/2 -translate-y-1/2 absolute left-1/2 overflow-clip size-[16px] top-1/2" data-name="Check Icon">
        <div className="absolute inset-[8.33%]" data-name="Vector">
          <svg className="absolute block inset-0" fill="none" preserveAspectRatio="none" viewBox="0 0 13.3333 13.3333">
            <path d={svgPaths.p17a55a00} fill="var(--fill-0, #78788F)" id="Vector" />
          </svg>
        </div>
      </div>
    </div>
...
function Batida2() {
  return (
    <div className="bg-[#eaf8ff] content-stretch flex gap-[10px] items-center justify-center px-[10px] py-[19px] relative rounded-[168px] shrink-0 size-[48px]" data-name="batida">
      <div aria-hidden="true" className="absolute border border-[#c2c2cd] border-solid inset-0 pointer-events-none rounded-[168px]" />
      <Check />
      <p className="font-['Open_Sans:SemiBold',sans-serif] font-semibold leading-[20px] relative shrink-0 text-[#3a3a45] text-[14px] tracking-[0.035px]" style={{ fontVariationSettings: "\'wdth\' 100" }}>
        12:00
      </p>
    </div>
  );
...
function Batida3() {
  return (
    <div className="content-stretch flex items-center justify-center px-[10px] py-[19px] relative rounded-[168px] shrink-0 size-[48px]" data-name="batida">
      <div aria-hidden="true" className="absolute border border-[#c2c2cd] border-solid inset-0 pointer-events-none rounded-[168px]" />
      <p className="font-['Open_Sans:Regular',sans-serif] leading-[20px] not-italic relative shrink-0 text-[#2a2a33] text-[14px] tracking-[0.035px]">18:01</p>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex gap-[12px] items-center relative shrink-0 w-full" data-name="Label">
      <div className="content-stretch flex items-center relative shrink-0" data-name="Typography">
        <div className="flex flex-col font-['Open_Sans:SemiBold',sans-serif] font-semibold justify-center leading-[0] relative shrink-0 text-[#2a2a33] text-[14px] tracking-[0.1246px] whitespace-nowrap" style={{ fontVariationSettings: "\'wdth\' 100" }}>
    ...
    <div className="bg-white flex-[1_0_0] h-full min-h-px min-w-px relative rounded-[4px]" data-name="Box">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[8px] items-center px-[16px] py-[10px] relative size-full">
          <div className="content-stretch flex flex-[1_0_0] items-center min-h-px min-w-px relative" data-name="Typography">
            <div className="flex flex-[1_0_0] flex-col font-['Open_Sans:Regular',sans-serif] justify-center leading-[0] min-h-px min-w-px not-italic relative text-[#2a2a33] text-[14px] tracking-[0.1246px]">
              <p className="leading-[18px] whitespace-pre-wrap">Marcação indevida</p>
            </div>
          </div>
...
function Frame2() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-start relative shrink-0 w-full">
      <div className="flex flex-col font-['Open_Sans:Regular',sans-serif] justify-center leading-[20px] not-italic relative shrink-0 text-[#2a2a33] text-[0px] text-[14px] tracking-[0.035px] w-full whitespace-pre-wrap">
        <p className="font-['Open_Sans:SemiBold',sans-serif] font-semibold mb-0" style={{ fontVariationSettings: "\'wdth\' 100" }}>
          Use esta tela para cancelar uma batida registrada por engano.
        </p>
        <p className="mb-0">&nbsp;</p>
...
export default function CancelarBatidaPreenchido() {
  return (
    <div className="bg-white relative size-full" data-name="Cancelar batida – Preenchido">
      <Header />
      <Body />
    </div>
  );
