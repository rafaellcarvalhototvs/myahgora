import svgPaths from "./svg-417yoym9v1";
...
export default function CancelarBatidaSelecaoDeBatida() {
  return (
    <div className="bg-white relative size-full" data-name="Cancelar batida – Seleção de batida">
      <Header />
      <Body />
    </div>
  );
