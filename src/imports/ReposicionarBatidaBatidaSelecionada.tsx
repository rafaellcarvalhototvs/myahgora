import svgPaths from "./svg-sty0pab0bc";
...
export default function ReposicionarBatidaBatidaSelecionada() {
  return (
    <div className="bg-white relative size-full" data-name="Reposicionar batida – Batida selecionada">
      <Header />
      <Body />
    </div>
  );
