import svgPaths from "./svg-krmqhgj5cl";
  ...
  return (
    <div className="relative shrink-0 size-[24px]" data-name="icon">
      <svg className="absolute block inset-0" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="icon">
          <path d={svgPaths.p25e12200} fill="var(--fill-0, #0C6D9E)" id="icon_2" />
        </g>
      </svg>
    </div>
  );
...
function Container() {
  return (
    <div className="bg-[#eaf8ff] content-stretch flex items-center justify-center p-[8px] relative rounded-[48px] shrink-0" data-name="Container">
      <Icon />
    </div>
  );
}
...
export default function Checkbox() {
  return (
    <div className="content-stretch cursor-pointer flex items-center relative size-full" data-name="Checkbox">
      <Checkbox1 />
      <LabelWrapper />
    </div>
  );
