import svgPaths from "./svg-sw0ycfg3d1";
...
function Text() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start min-h-px min-w-px overflow-clip py-[8px] relative" data-name="Text">
      <p className="font-['Open_Sans:Regular',sans-serif] leading-[0] not-italic relative shrink-0 text-[#3a3a45] text-[0px] text-[14px] tracking-[0.035px] w-full whitespace-pre-wrap">
        <span className="leading-[20px]">{`Você estará solicitando `}</span>
        <span className="font-['Open_Sans:SemiBold',sans-serif] font-semibold leading-[20px]" style={{ fontVariationSettings: "\'wdth\' 100" }}>
          3 horas
        </span>
        <span className="leading-[20px]">{` de abono.`}</span>
      </p>
    </div>
  );
}
  ...
  return (
    <div className="relative rounded-[4px] shrink-0 w-full">
      ...
      <div className="content-stretch flex flex-col gap-[24px] items-start p-[24px] relative w-full">
        ...
        <div className="bg-[#ebf3fc] relative rounded-[4px] shrink-0 w-full" data-name="<Alert>">
...
function Frame5() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-start relative shrink-0 w-full">
      <div className="flex flex-col font-['Open_Sans:Regular',sans-serif] justify-center leading-[0] min-w-full not-italic relative shrink-0 text-[#2a2a33] text-[0px] tracking-[0.035px] w-[min-content]">
...
export default function SolicitarAbono() {
  return (
    <div className="bg-white relative size-full" data-name="Solicitar Abono">
      <Header />
      <Body />
    </div>
  );
