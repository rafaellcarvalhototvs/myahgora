import svgPaths from "./svg-2g390wq63e";
    ...
    <div className="content-stretch flex flex-[1_0_0] gap-[6px] h-[22px] items-center min-h-px min-w-px relative" data-name="Content">
      <div className="content-stretch flex flex-col items-start py-[5px] relative shrink-0" data-name="Typography">
        <div className="flex flex-col font-['Open_Sans:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#dd1818] text-[14px] tracking-[0.4382px] whitespace-nowrap">
          <p className="leading-[14px]">Mensagem obrigatória.</p>
        </div>
      </div>
    </div>
  );
...
function Frame6() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-start py-[4px] relative shrink-0 w-full">
      ...
      <div className="flex flex-col font-['Open_Sans:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#dd1818] text-[14px] tracking-[0.4382px] whitespace-nowrap">
        <p className="leading-[14px]">Formato de arquivo inválido.</p>
      </div>
    </div>
  );
}
...
export default function EnviarMensagemValidacaoDeErros() {
  return (
    <div className="bg-white relative size-full" data-name="Enviar mensagem – Validação de erros">
      <Header />
      <Body />
    </div>
  );
