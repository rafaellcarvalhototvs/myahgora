import svgPaths from "./svg-4flcbqoqk9";
  ...
  return (
    <div className="relative shrink-0 size-[130px]" data-name="Sucess">
      <svg className="absolute block inset-0" fill="none" preserveAspectRatio="none" viewBox="0 0 130 130">
        <g id="Sucess">
          <rect fill="var(--fill-0, #DD1818)" height="130" id="Rectangle 331" opacity="0.1" rx="65" width="130" />
          <rect fill="var(--fill-0, #DD1818)" height="90" id="Rectangle 332" rx="45" width="90" x="20" y="20" />
          <path d={svgPaths.p572cd00} fill="var(--fill-0, white)" id="Vector" />
        </g>
      </svg>
    </div>
  );
  ...
  return (
    <div className="content-stretch flex flex-col gap-[12px] items-center relative shrink-0 w-full" data-name="Text">
      <div className="content-stretch flex items-center justify-center relative shrink-0 w-full" data-name="Typography">
        <div className="flex flex-[1_0_0] flex-col font-['Open_Sans:SemiBold',sans-serif] font-semibold justify-center leading-[0] min-h-px min-w-px relative text-[#2a2a33] text-[20px] text-center tracking-[0.03px]" style={{ fontVariationSettings: "\'wdth\' 100" }}>
          <p className="leading-[30px] whitespace-pre-wrap">Erro ao processar a solicitação</p>
        </div>
      </div>
      <div className="content-stretch flex items-center justify-center relative shrink-0 w-full" data-name="Typography">
        <div className="flex flex-[1_0_0] flex-col font-['Open_Sans:Regular',sans-serif] justify-center leading-[0] min-h-px min-w-px not-italic relative text-[#78788f] text-[14px] text-center tracking-[0.035px]">
          <p className="leading-[20px] whitespace-pre-wrap">Tente novamente mais tarde. Se o problema persistir, entre em contato com seu gestor ou com o RH.</p>
        </div>
      </div>
    </div>
  );
