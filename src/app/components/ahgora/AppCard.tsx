...
export function AppCard() {
  return (
    <section className="px-6 flex flex-col gap-4" aria-labelledby="apps-section-title">
      ...
      <div 
        className="bg-card rounded-[4px] border border-border/60 shadow-[0px_1px_2px_0px_rgba(0,0,0,0.16)] dark:shadow-[0px_16px_32px_0px_rgba(0,0,0,0.22)] p-4 flex flex-col gap-6 transition-colors"
