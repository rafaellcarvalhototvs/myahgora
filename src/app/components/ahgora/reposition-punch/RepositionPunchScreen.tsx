  ...
  return (
    <div className="fixed inset-0 z-50 overflow-hidden bg-[#f0f0f5] flex justify-center items-stretch font-['Open_Sans'] h-[100dvh] w-screen">
      <div className="w-full max-w-md bg-white h-full relative shadow-2xl flex flex-col">
        ...
        <h1 className="text-white font-semibold text-[18px] leading-[28px] tracking-[0.027px]">Reposicionar batida</h1>
      </div>
      ...
      <div className="flex-1 min-h-0 overflow-y-auto w-full bg-white relative scroll-smooth">
        ...
        <div className="space-y-2 relative">
          ...
          <button
            ...
            className={`w-full border rounded-[4px] px-4 py-3 flex justify-between items-center bg-white ${errors.date ? 'border-destructive border-2' : 'border-[#78788f]'}`}
          >
        ...
        <div className="space-y-2">
          <AhgoraInput
            ...
            startIcon={<AccessTimeIcon className="text-[#3a3a45]" fontSize="small" />}
            error={!!errors.time}
